...
const breadcrumbMap: Record<Screen, Array<{ label: string; active?: boolean }>> = {
  ...
  competencies: [
    { label: "Curriculum" },
    { label: "Competencies", active: true },
  ],
  review: [
    { label: "Curriculum" },
    { label: "Review & Publish", active: true },
  ],
};
    ...
    <CurriculumProvider>
      <div className="flex h-screen w-full overflow-hidden bg-gray-50 font-sans">
        ...
        <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
          ...
          {screen === "competencies" && <Competencies onNavigate={setScreen} />}
          {screen === "settings" && <CurriculumSettings onNavigate={setScreen} />}
          {screen === "review" && <ReviewPublish onNavigate={setScreen} />}
